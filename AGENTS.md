...
- CivicProcure v0.1.1 must not call live LLMs or live vendor portals.
...
- CivicProcure may reference CivicClerk, CivicContracts, and CivicRecords concepts only through released contracts or deterministic sample data in v0.1.1.
